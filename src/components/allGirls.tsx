...
const AllGirlsParticipants: React.FC = () => {
  ...
  async function generatePdf(data: CrossData[], title?: string) {
    ...
    page.drawText(title || "All Participants - Girls", {
      x: margin,
      y,
      color: rgb(0, 0, 0),
      size: 30,
  ...
  const handleDownload = async () => {
    ...
    setLoading(true);
    const pdfBytes = await generatePdf(validatedParticipants, "All Participants - Girls");
...
export default AllGirlsParticipants;
